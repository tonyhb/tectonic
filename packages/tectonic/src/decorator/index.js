...
export default function load(loadQueries: { [key: string]: Query } | Function = {}) {
  ...
  return (WrappedComponent: Class<React$Component<*, *, *>>) => {
    class TectonicComponent extends Component {
      ...
      /**
       * query is passed as a prop to the decorated component, providing the
       * full query function as defined in the documentation and in v2.0.
       *
       * This allows V1 users to use .query without breaking createModel etc.
       */
